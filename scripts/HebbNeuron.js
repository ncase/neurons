function Neuron(){
	...
	self.pulse = function(signal){
		...
		// Highlight!
		/*if(self.startingStrength==1){
			self.highlight += 1; // edge case
		}else{
			self.highlight += (signal.strength+(self.startingStrength-2))/self.startingStrength;
		}
	...
	self.draw = function(ctx){
		...
		ctx.scale(self.scale*self.smoosh,self.scale*self.smoosh);
